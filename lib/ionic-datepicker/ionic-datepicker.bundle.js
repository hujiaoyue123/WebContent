      ...
      provider.openDatePicker = function (ipObj) {
        ...
        if ($scope.mainObj.templateType.toLowerCase() == 'popup') {
          $scope.popup = $ionicPopup.show({
            templateUrl: 'lib/ionic-datepicker/ionic-datepicker-popup.html',
            scope: $scope,
            cssClass: 'ionic_datepicker_popup',
            buttons: buttons
          });
        } else {
			$ionicModal.fromTemplateUrl('lib/ionic-datepicker/ionic-datepicker-modal.html', {
			    scope: $scope,
...
/************module*******/
angular.module('ionic-datepicker', ['ionic','ionic-datepicker.service','ionic-datepicker.provider'])